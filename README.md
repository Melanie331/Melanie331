...
[View resume](https://drive.google.com/file/d/13d6iZB0ZQaMpK7xFau-xmGPmgw_5qwxx/view?usp=drive_link)
...
## Additional projects
| Project Title                                         | Year       | Description                                                                                      | Impact                                                                                          |
|------------------------------------------------------|------------|-------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
[Maternacare USSD App](https://www.figma.com/proto/KRJDZx0PUJi2v5PbtDOhbc/USSD-App-for-accessing-prenatal-and-postnatal-services-in-Africa?node-id=311-1818&t=duBu0Biyteo2XK7j-0&scaling=scale-down&page-id=11%3A2&starting-point-node-id=311%3A1818&show-proto-sidebar=1)| 2024 | Designed the User Interface prototype of the USSD App (Maternacare) aimed at improving access to Prenatal and Postnatal services in Africa. | Maternacare aimed at improving access to prenatal and postnatal services in Africa remotely by connecting antenatal patients to local healthcare providers, improving maternal and child health outcomes.| 
